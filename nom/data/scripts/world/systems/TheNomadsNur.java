...
public class TheNomadsNur implements SectorGeneratorPlugin, CampaignArmadaControllerEventListener
{
	...
	private void init_station_cargo( SectorEntityToken station )
	{
		...
		// restocker script
		String[] restock_ship_variant_or_wing_ids = { "nom_gila_monster_antibattleship", "nom_sandstorm_assault", "nom_scorpion_assault","nom_komodo_mk2_assault", "nom_komodo_assault", "nom_flycatcher_carrier", "nom_yellowjacket_sniper", "nom_death_bloom_strike", "nom_wurm_assault",   "nom_iguana_wing",            "nom_scarab_wing" };
		FleetMemberType[] restock_ship_types = {       FleetMemberType.SHIP,              FleetMemberType.SHIP,    FleetMemberType.SHIP,  FleetMemberType.SHIP,    FleetMemberType.SHIP, FleetMemberType.SHIP,      FleetMemberType.SHIP,      FleetMemberType.SHIP,     FleetMemberType.SHIP, FleetMemberType.FIGHTER_WING, FleetMemberType.FIGHTER_WING };
		int[] restock_ship_count_cap = {               1,                                 2,                       3,                     2,                       4,                    4,                         2,                         1,                        5,                    6,                            8  };
		float[] restock_ship_wait_days = {             92.0f,                             59.0f,                   29.0f,                 25.0f,                   21.0f,                15.0f,                     13.0f,                     29.0f,                    9.0f,                 5.0f,                         4.0f  };
