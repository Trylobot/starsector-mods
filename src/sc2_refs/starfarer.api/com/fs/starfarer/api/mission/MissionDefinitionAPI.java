...
public interface MissionDefinitionAPI {
	 ...
	 */
	public void addToFleet(FleetSide side, String variantId, FleetMemberType type, boolean isFlagship);
	 ...
	 * @param isFlagship Set to true for the player's ship, false otherwise.
	 */
	public void addToFleet(FleetSide side, String variantId, FleetMemberType type, String shipName, boolean isFlagship);
